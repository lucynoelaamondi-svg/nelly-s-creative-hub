    ...
    <section id="contact" className="section-padding">
      <div className="section-container">
        ...
        <div className="grid md:grid-cols-2 gap-12 max-w-4xl mx-auto items-start">
          ...
          >
            {[
              { href: "https://wa.me/254743342392", icon: <MessageCircle size={20} />, label: "WhatsApp", desc: "Chat with me directly" },
              { href: "mailto:lucynoela.amondi@gmail.com", icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="20" height="16" x="2" y="4" rx="2"/><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/></svg>, label: "Email", desc: "lucynoela.amondi@gmail.com" },
              {
